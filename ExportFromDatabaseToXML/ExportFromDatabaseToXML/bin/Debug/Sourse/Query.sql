...
DECLARE @codeMSP                VARCHAR(5)  = '02800'                   --Код меры для выгрузки.
...
CREATE TABLE #НАЗНАЧЕНИЯ (
    ...
    [МСП-РаспорядительныйДокумент-Реквизиты-РазмерМСП]          FLOAT,              --Элемент;  Обязательный;       Вещественное число с дробной частью в 2 знака   Актуальный на дату передачи сведений размер меры социальной поддержки
...
INSERT INTO #НАЗНАЧЕНИЯ ([Идентификатор], [ПравообладательМСП], [ПравообладательМСП-Район-Код], [ПравообладательМСП-Район-УТ2:Наименование], [Представитель], [МСП-ГИД-КодПолучателя], [МСП-ГИД-Ребенок], 
    ...
    [МСП-РаспорядительныйДокумент-Реквизиты-Номер], [МСП-РаспорядительныйДокумент-Реквизиты-РазмерМСП], [МСП-НПА], [МСП-КодМСП], [МСП-СпособДоставки-ТипАдреса], [МСП-СпособДоставки-БанковскиеРеквизиты-УТ2:БИК], 
...
SELECT DISTINCT
    ...
    CONVERT(DATE, period.A_LASTDATE)    AS [МСП-РаспорядительныйДокумент-Период-УТ2:По],
    CONVERT(DATE, petition.A_DONEDATE)  AS [МСП-РаспорядительныйДокумент-Реквизиты-Дата],
    petition.A_DECISION_NUM             AS [МСП-РаспорядительныйДокумент-Реквизиты-Номер],
    ROUND(payAmount.A_AMOUNT, 2)        AS [МСП-РаспорядительныйДокумент-Реквизиты-РазмерМСП],
    NULL                                AS [МСП-НПА],
    typeServ.CODE_FROM_PFR              AS [МСП-КодМСП],
    CASE
        WHEN payment.DELIVERYWAY = @deliveryRussianPost AND payment.ALTERNATIVEADDRESSDEIVERY = personalCardHolder.A_REGFLAT       THEN 4
        WHEN payment.DELIVERYWAY = @deliveryRussianPost AND payment.ALTERNATIVEADDRESSDEIVERY = personalCardHolder.A_TEMPREGFLAT   THEN 5
        WHEN payment.DELIVERYWAY = @deliveryRussianPost AND payment.ALTERNATIVEADDRESSDEIVERY = personalCardHolder.A_LIVEFLAT      THEN 6  
        ELSE NULL
    END                                 AS [МСП-СпособДоставки-ТипАдреса],
    CASE     
        WHEN payment.DELIVERYWAY IN (2, 7) THEN bank.A_BIK 
        ELSE NULL
...
----Нужные меры социальной поддержки.
    INNER JOIN CLASSIFY_MSP_FROM_PFR typeServ
        ON typeServ.MSP_LK_NPD_FROM_PPR = servServ.A_SERV	
            AND typeServ.CODE_FROM_PFR = @codeMSP
...
SELECT 
    ...
    CONVERT(DATE, actDocuments.COMPLETIONSACTIONDATE)                   AS [ПериодДействия-УТ2:По]
FROM #НАЗНАЧЕНИЯ 
----Назначения МСП.
...
CREATE TABLE #ПЕРСОНАЛЬНАЯ_ИНФОРМАЦИЯ (
    ...
    [УТ2:ГрДатаРождения-УТ2:ДатаРождения]   DATE,           --Элемент;  Обязательный;       Дата;               Дата рождения правообладателя.
...
--Выборка.
INSERT INTO #ПЕРСОНАЛЬНАЯ_ИНФОРМАЦИЯ ([Идентификатор], [УТ2:СНИЛС], [УТ2:ФИО-УТ2:Фамилия], [УТ2:ФИО-УТ2:Имя], [УТ2:ФИО-УТ2:Отчество], [УТ2:Пол], [УТ2:ГрДатаРождения-УТ2:ДатаРождения],    
...
SELECT DISTINCT
    ...
    CONVERT(DATE, personalCard.BIRTHDATE)                           AS [УТ2:ГрДатаРождения-УТ2:ДатаРождения],
...
SELECT DISTINCT
    ...
    okrug.A_NAME                                        AS [УТ2:Округ-Т2:Название],
...
SELECT
    ...
    personalCardHolder.[УТ2:ГрДатаРождения-УТ2:ДатаРождения]            AS [ПравообладательМСП-УТ2:ГрДатаРождения-УТ2:ДатаРождения],
    NULL                                                                AS [ПравообладательМСП-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:День],
    NULL                                                                AS [ПравообладательМСП-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Месяц],
    NULL                                                                AS [ПравообладательМСП-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Год],
    ...
    addressRegHolder.[УТ2:GUID]                                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:GUID],
    addressRegHolder.[УТ2:Индекс]                                       AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Индекс],
    addressRegHolder.[УТ2:Регион-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-Т2:Название],
    addressRegHolder.[УТ2:Регион-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-УТ2:Сокращение],
    addressRegHolder.[УТ2:Округ-Т2:Название]                            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-Т2:Название],
    addressRegHolder.[УТ2:Округ-УТ2:Сокращение]                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-УТ2:Сокращение],
    addressRegHolder.[УТ2:Район-Т2:Название]                            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-Т2:Название],
    addressRegHolder.[УТ2:Район-УТ2:Сокращение]                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-УТ2:Сокращение],       
    addressRegHolder.[УТ2:Город-Т2:Название]                            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-Т2:Название],
    addressRegHolder.[УТ2:Город-УТ2:Сокращение]                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-УТ2:Сокращение],
    addressRegHolder.[УТ2:ВнутригородскойРайон-Т2:Название]             AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-Т2:Название],
    addressRegHolder.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]          AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressRegHolder.[УТ2:НаселенныйПункт-Т2:Название]                  AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-Т2:Название],
    addressRegHolder.[УТ2:НаселенныйПункт-УТ2:Сокращение]               AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressRegHolder.[УТ2:Улица-Т2:Название]                            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-Т2:Название],
    addressRegHolder.[УТ2:Улица-УТ2:Сокращение]                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-УТ2:Сокращение],
    addressRegHolder.[УТ2:Дом]                                          AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Дом],
    addressRegHolder.[УТ2:Строение]                                     AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Строение],
    addressRegHolder.[УТ2:Владение]                                     AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Владение],
    addressRegHolder.[УТ2:Корпус]                                       AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Корпус],
    addressRegHolder.[УТ2:Квартира]                                     AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Квартира],
    addressTempHolder.[УТ2:GUID]                                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:GUID],
    addressTempHolder.[УТ2:Индекс]                                      AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Индекс],
    addressTempHolder.[УТ2:Регион-Т2:Название]                          AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-Т2:Название],
    addressTempHolder.[УТ2:Регион-УТ2:Сокращение]                       AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-УТ2:Сокращение],
    addressTempHolder.[УТ2:Округ-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-Т2:Название],
    addressTempHolder.[УТ2:Округ-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-УТ2:Сокращение],
    addressTempHolder.[УТ2:Район-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-Т2:Название],
    addressTempHolder.[УТ2:Район-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-УТ2:Сокращение],       
    addressTempHolder.[УТ2:Город-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-Т2:Название],
    addressTempHolder.[УТ2:Город-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-УТ2:Сокращение],
    addressTempHolder.[УТ2:ВнутригородскойРайон-Т2:Название]            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-Т2:Название],
    addressTempHolder.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressTempHolder.[УТ2:НаселенныйПункт-Т2:Название]                 AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-Т2:Название],
    addressTempHolder.[УТ2:НаселенныйПункт-УТ2:Сокращение]              AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressTempHolder.[УТ2:Улица-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-Т2:Название],
    addressTempHolder.[УТ2:Улица-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-УТ2:Сокращение],
    addressTempHolder.[УТ2:Дом]                                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Дом],
    addressTempHolder.[УТ2:Строение]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Строение],
    addressTempHolder.[УТ2:Владение]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Владение],
    addressTempHolder.[УТ2:Корпус]                                      AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Корпус],
    addressTempHolder.[УТ2:Квартира]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Квартира],
    addressLiveHolder.[УТ2:GUID]                                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:GUID],
    addressLiveHolder.[УТ2:Индекс]                                      AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Индекс],
    addressLiveHolder.[УТ2:Регион-Т2:Название]                          AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-Т2:Название],
    addressLiveHolder.[УТ2:Регион-УТ2:Сокращение]                       AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-УТ2:Сокращение],
    addressLiveHolder.[УТ2:Округ-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-Т2:Название],
    addressLiveHolder.[УТ2:Округ-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-УТ2:Сокращение],
    addressLiveHolder.[УТ2:Район-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-Т2:Название],
    addressLiveHolder.[УТ2:Район-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-УТ2:Сокращение],       
    addressLiveHolder.[УТ2:Город-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-Т2:Название],
    addressLiveHolder.[УТ2:Город-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-УТ2:Сокращение],
    addressLiveHolder.[УТ2:ВнутригородскойРайон-Т2:Название]            AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-Т2:Название],
    addressLiveHolder.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressLiveHolder.[УТ2:НаселенныйПункт-Т2:Название]                 AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-Т2:Название],
    addressLiveHolder.[УТ2:НаселенныйПункт-УТ2:Сокращение]              AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressLiveHolder.[УТ2:Улица-Т2:Название]                           AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-Т2:Название],
    addressLiveHolder.[УТ2:Улица-УТ2:Сокращение]                        AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-УТ2:Сокращение],
    addressLiveHolder.[УТ2:Дом]                                         AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Дом],
    addressLiveHolder.[УТ2:Строение]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Строение],
    addressLiveHolder.[УТ2:Владение]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Владение],
    addressLiveHolder.[УТ2:Корпус]                                      AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Корпус],
    addressLiveHolder.[УТ2:Квартира]                                    AS [ПравообладательМСП-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Квартира],
    ...
    identityСardHolder.[УТ2:ДатаВыдачи]                                 AS [ПравообладательМСП-УТ2:УдостоверяющийДокумент-УТ2:ДатаВыдачи],
    identityСardHolder.[УТ2:КемВыдан]                                   AS [ПравообладательМСП-УТ2:УдостоверяющийДокумент-УТ2:КемВыдан],
    identityСardHolder.[УТ2:СрокДействия]                               AS [ПравообладательМСП-УТ2:УдостоверяющийДокумент-УТ2:СрокДействия],
    identityСardHolder.[УТ2:КодПодразделения]                           AS [ПравообладательМСП-УТ2:УдостоверяющийДокумент-УТ2:КодПодразделения],
    servServ.[ПравообладательМСП-Район-Код]                             AS [Представитель-Район-Код],
    servServ.[ПравообладательМСП-Район-УТ2:Наименование]                AS [Представитель-Район-УТ2:Наименование],
    ...
    personalCardReceiver.[УТ2:ГрДатаРождения-УТ2:ДатаРождения]          AS [Представитель-УТ2:ГрДатаРождения-УТ2:ДатаРождения],
    NULL                                                                AS [Представитель-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:День],
    NULL                                                                AS [Представитель-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Месяц],
    NULL                                                                AS [Представитель-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Год],
    ...
    addressRegReceiver.[УТ2:GUID]                                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:GUID],
    addressRegReceiver.[УТ2:Индекс]                                     AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Индекс],
    addressRegReceiver.[УТ2:Регион-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-Т2:Название],
    addressRegReceiver.[УТ2:Регион-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-УТ2:Сокращение],
    addressRegReceiver.[УТ2:Округ-Т2:Название]                          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-Т2:Название],
    addressRegReceiver.[УТ2:Округ-УТ2:Сокращение]                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-УТ2:Сокращение],
    addressRegReceiver.[УТ2:Район-Т2:Название]                          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-Т2:Название],
    addressRegReceiver.[УТ2:Район-УТ2:Сокращение]                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-УТ2:Сокращение],       
    addressRegReceiver.[УТ2:Город-Т2:Название]                          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-Т2:Название],
    addressRegReceiver.[УТ2:Город-УТ2:Сокращение]                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-УТ2:Сокращение],
    addressRegReceiver.[УТ2:ВнутригородскойРайон-Т2:Название]           AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-Т2:Название],
    addressRegReceiver.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]        AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressRegReceiver.[УТ2:НаселенныйПункт-Т2:Название]                AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-Т2:Название],
    addressRegReceiver.[УТ2:НаселенныйПункт-УТ2:Сокращение]             AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressRegReceiver.[УТ2:Улица-Т2:Название]                          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-Т2:Название],
    addressRegReceiver.[УТ2:Улица-УТ2:Сокращение]                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-УТ2:Сокращение],
    addressRegReceiver.[УТ2:Дом]                                        AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Дом],
    addressRegReceiver.[УТ2:Строение]                                   AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Строение],
    addressRegReceiver.[УТ2:Владение]                                   AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Владение],
    addressRegReceiver.[УТ2:Корпус]                                     AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Корпус],
    addressRegReceiver.[УТ2:Квартира]                                   AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Квартира],
    addressTempReceiver.[УТ2:GUID]                                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:GUID],
    addressTempReceiver.[УТ2:Индекс]                                    AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Индекс],
    addressTempReceiver.[УТ2:Регион-Т2:Название]                        AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-Т2:Название],
    addressTempReceiver.[УТ2:Регион-УТ2:Сокращение]                     AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-УТ2:Сокращение],
    addressTempReceiver.[УТ2:Округ-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-Т2:Название],
    addressTempReceiver.[УТ2:Округ-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-УТ2:Сокращение],
    addressTempReceiver.[УТ2:Район-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-Т2:Название],
    addressTempReceiver.[УТ2:Район-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-УТ2:Сокращение],       
    addressTempReceiver.[УТ2:Город-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-Т2:Название],
    addressTempReceiver.[УТ2:Город-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-УТ2:Сокращение],
    addressTempReceiver.[УТ2:ВнутригородскойРайон-Т2:Название]          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-Т2:Название],
    addressTempReceiver.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressTempReceiver.[УТ2:НаселенныйПункт-Т2:Название]               AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-Т2:Название],
    addressTempReceiver.[УТ2:НаселенныйПункт-УТ2:Сокращение]            AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressTempReceiver.[УТ2:Улица-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-Т2:Название],
    addressTempReceiver.[УТ2:Улица-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-УТ2:Сокращение],
    addressTempReceiver.[УТ2:Дом]                                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Дом],
    addressTempReceiver.[УТ2:Строение]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Строение],
    addressTempReceiver.[УТ2:Владение]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Владение],
    addressTempReceiver.[УТ2:Корпус]                                    AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Корпус],
    addressTempReceiver.[УТ2:Квартира]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Квартира],
    addressLiveReceiver.[УТ2:GUID]                                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:GUID],
    addressLiveReceiver.[УТ2:Индекс]                                    AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Индекс],
    addressLiveReceiver.[УТ2:Регион-Т2:Название]                        AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-Т2:Название],
    addressLiveReceiver.[УТ2:Регион-УТ2:Сокращение]                     AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-УТ2:Сокращение],
    addressLiveReceiver.[УТ2:Округ-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-Т2:Название],
    addressLiveReceiver.[УТ2:Округ-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-УТ2:Сокращение],
    addressLiveReceiver.[УТ2:Район-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-Т2:Название],
    addressLiveReceiver.[УТ2:Район-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-УТ2:Сокращение],       
    addressLiveReceiver.[УТ2:Город-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-Т2:Название],
    addressLiveReceiver.[УТ2:Город-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-УТ2:Сокращение],
    addressLiveReceiver.[УТ2:ВнутригородскойРайон-Т2:Название]          AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-Т2:Название],
    addressLiveReceiver.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressLiveReceiver.[УТ2:НаселенныйПункт-Т2:Название]               AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-Т2:Название],
    addressLiveReceiver.[УТ2:НаселенныйПункт-УТ2:Сокращение]            AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressLiveReceiver.[УТ2:Улица-Т2:Название]                         AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-Т2:Название],
    addressLiveReceiver.[УТ2:Улица-УТ2:Сокращение]                      AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-УТ2:Сокращение],
    addressLiveReceiver.[УТ2:Дом]                                       AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Дом],
    addressLiveReceiver.[УТ2:Строение]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Строение],
    addressLiveReceiver.[УТ2:Владение]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Владение],
    addressLiveReceiver.[УТ2:Корпус]                                    AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Корпус],
    addressLiveReceiver.[УТ2:Квартира]                                  AS [Представитель-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Квартира],
    ...
    identityСardReceiver.[УТ2:ДатаВыдачи]                               AS [Представитель-УТ2:УдостоверяющийДокумент-УТ2:ДатаВыдачи],
    identityСardReceiver.[УТ2:КемВыдан]                                 AS [Представитель-УТ2:УдостоверяющийДокумент-УТ2:КемВыдан],
    identityСardReceiver.[УТ2:СрокДействия]                             AS [Представитель-УТ2:УдостоверяющийДокумент-УТ2:СрокДействия],
    ...
    personalCardChild.[УТ2:ГрДатаРождения-УТ2:ДатаРождения]             AS [МСП-ГИД-Ребенок-УТ2:ГрДатаРождения-УТ2:ДатаРождения],
    NULL                                                                AS [МСП-ГИД-Ребенок-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:День],
    NULL                                                                AS [МСП-ГИД-Ребенок-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Месяц],
    NULL                                                                AS [МСП-ГИД-Ребенок-УТ2:ГрДатаРождения-УТ2:ДатаРожденияОсобая-УТ2:Год],
    addressRegChild.[УТ2:GUID]                                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:GUID],
    addressRegChild.[УТ2:Индекс]                                        AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Индекс],
    addressRegChild.[УТ2:Регион-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-Т2:Название],
    addressRegChild.[УТ2:Регион-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Регион-УТ2:Сокращение],
    addressRegChild.[УТ2:Округ-Т2:Название]                             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-Т2:Название],
    addressRegChild.[УТ2:Округ-УТ2:Сокращение]                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Округ-УТ2:Сокращение],
    addressRegChild.[УТ2:Район-Т2:Название]                             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-Т2:Название],
    addressRegChild.[УТ2:Район-УТ2:Сокращение]                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Район-УТ2:Сокращение],       
    addressRegChild.[УТ2:Город-Т2:Название]                             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-Т2:Название],
    addressRegChild.[УТ2:Город-УТ2:Сокращение]                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Город-УТ2:Сокращение],
    addressRegChild.[УТ2:ВнутригородскойРайон-Т2:Название]              AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-Т2:Название],
    addressRegChild.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]           AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressRegChild.[УТ2:НаселенныйПункт-Т2:Название]                   AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-Т2:Название],
    addressRegChild.[УТ2:НаселенныйПункт-УТ2:Сокращение]                AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressRegChild.[УТ2:Улица-Т2:Название]                             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-Т2:Название],
    addressRegChild.[УТ2:Улица-УТ2:Сокращение]                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Улица-УТ2:Сокращение],
    addressRegChild.[УТ2:Дом]                                           AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Дом],
    addressRegChild.[УТ2:Строение]                                      AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Строение],
    addressRegChild.[УТ2:Владение]                                      AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Владение],
    addressRegChild.[УТ2:Корпус]                                        AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Корпус],
    addressRegChild.[УТ2:Квартира]                                      AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресРегистрации-УТ2:Квартира],
    addressTempChild.[УТ2:GUID]                                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:GUID],
    addressTempChild.[УТ2:Индекс]                                       AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Индекс],
    addressTempChild.[УТ2:Регион-Т2:Название]                           AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-Т2:Название],
    addressTempChild.[УТ2:Регион-УТ2:Сокращение]                        AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Регион-УТ2:Сокращение],
    addressTempChild.[УТ2:Округ-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-Т2:Название],
    addressTempChild.[УТ2:Округ-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Округ-УТ2:Сокращение],
    addressTempChild.[УТ2:Район-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-Т2:Название],
    addressTempChild.[УТ2:Район-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Район-УТ2:Сокращение],       
    addressTempChild.[УТ2:Город-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-Т2:Название],
    addressTempChild.[УТ2:Город-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Город-УТ2:Сокращение],
    addressTempChild.[УТ2:ВнутригородскойРайон-Т2:Название]             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-Т2:Название],
    addressTempChild.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressTempChild.[УТ2:НаселенныйПункт-Т2:Название]                  AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-Т2:Название],
    addressTempChild.[УТ2:НаселенныйПункт-УТ2:Сокращение]               AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressTempChild.[УТ2:Улица-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-Т2:Название],
    addressTempChild.[УТ2:Улица-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Улица-УТ2:Сокращение],
    addressTempChild.[УТ2:Дом]                                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Дом],
    addressTempChild.[УТ2:Строение]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Строение],
    addressTempChild.[УТ2:Владение]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Владение],
    addressTempChild.[УТ2:Корпус]                                       AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Корпус],
    addressTempChild.[УТ2:Квартира]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресПребывания-УТ2:Квартира],
    addressLiveChild.[УТ2:GUID]                                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:GUID],
    addressLiveChild.[УТ2:Индекс]                                       AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Индекс],
    addressLiveChild.[УТ2:Регион-Т2:Название]                           AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-Т2:Название],
    addressLiveChild.[УТ2:Регион-УТ2:Сокращение]                        AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Регион-УТ2:Сокращение],
    addressLiveChild.[УТ2:Округ-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-Т2:Название],
    addressLiveChild.[УТ2:Округ-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Округ-УТ2:Сокращение],
    addressLiveChild.[УТ2:Район-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-Т2:Название],
    addressLiveChild.[УТ2:Район-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Район-УТ2:Сокращение],       
    addressLiveChild.[УТ2:Город-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-Т2:Название],
    addressLiveChild.[УТ2:Город-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Город-УТ2:Сокращение],
    addressLiveChild.[УТ2:ВнутригородскойРайон-Т2:Название]             AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-Т2:Название],
    addressLiveChild.[УТ2:ВнутригородскойРайон-УТ2:Сокращение]          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:ВнутригородскойРайон-УТ2:Сокращение],
    addressLiveChild.[УТ2:НаселенныйПункт-Т2:Название]                  AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-Т2:Название],
    addressLiveChild.[УТ2:НаселенныйПункт-УТ2:Сокращение]               AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:НаселенныйПункт-УТ2:Сокращение],   
    addressLiveChild.[УТ2:Улица-Т2:Название]                            AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-Т2:Название],
    addressLiveChild.[УТ2:Улица-УТ2:Сокращение]                         AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Улица-УТ2:Сокращение],
    addressLiveChild.[УТ2:Дом]                                          AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Дом],
    addressLiveChild.[УТ2:Строение]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Строение],
    addressLiveChild.[УТ2:Владение]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Владение],
    addressLiveChild.[УТ2:Корпус]                                       AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Корпус],
    addressLiveChild.[УТ2:Квартира]                                     AS [МСП-ГИД-Ребенок-УТ2:ГрАдресаФЛ-УТ2:АдресФактический-УТ2:Квартира],
    ...
    сonfirmationDocument.[УТ2:ДатаВыдачи]                               AS [МСП-ПравоподтверждающийДокумент-УТ2:ДатаВыдачи],
    сonfirmationDocument.[УТ2:КемВыдан]                                 AS [МСП-ПравоподтверждающийДокумент-УТ2:КемВыдан],
    сonfirmationDocument.[ПериодДействия-УТ2:С]                         AS [МСП-ПравоподтверждающийДокумент-ПериодДействия-УТ2:С],
    сonfirmationDocument.[ПериодДействия-УТ2:По]                        AS [МСП-ПравоподтверждающийДокумент-ПериодДействия-УТ2:По],
    servServ.[МСП-РаспорядительныйДокумент-ДатаУстановления],
    servServ.[МСП-РаспорядительныйДокумент-Период-УТ2:С],
    servServ.[МСП-РаспорядительныйДокумент-Период-УТ2:По],
    servServ.[МСП-РаспорядительныйДокумент-Реквизиты-Дата],
    servServ.[МСП-РаспорядительныйДокумент-Реквизиты-Номер],
    servServ.[МСП-РаспорядительныйДокумент-Реквизиты-РазмерМСП],
    servServ.[МСП-НПА],
    servServ.[МСП-КодМСП],
...
FROM #НАЗНАЧЕНИЯ servServ
    ...
    LEFT JOIN #ПРАВОПОДТВЕРЖДАЮЩИЕ_ДОКУМЕНТЫ сonfirmationDocument
        ON сonfirmationDocument.[Назначение] = servServ.[Идентификатор]
